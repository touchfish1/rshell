...
export const enUS: Dict = {
  ...
  "home.hostList": "Hosts",
  "home.hostListHint": "Click Connect or host name to open a new tab. The Status column is a TCP reachability check to host:port, not ICMP ping.",
  ...
  "shortcutHelp.section.appearance": "Appearance & terminal font",
  "shortcutHelp.appearance.keys":
    "Use the top bar to switch dark/light/system theme; on the terminal page pick a monospace font preset (saved with font size)",
  ...
  "theme.ariaGroup": "Appearance & terminal font",
  "theme.appearance": "UI theme",
  "theme.dark": "Dark",
  "theme.light": "Light",
