...
export const zhCN: Dict = {
  ...
  "home.hostList": "主机列表",
  "home.hostListHint": "点击行内“连接”或主机名即可新建会话标签。列表「状态」为对主机:端口的 TCP 探测，与 ICMP ping 不同。",
  ...
  "shortcutHelp.section.appearance": "外观与终端字体",
  "shortcutHelp.appearance.keys": "顶栏可切换亮/暗/跟随系统；终端页可选等宽字体预设（与字号一并持久化）",
