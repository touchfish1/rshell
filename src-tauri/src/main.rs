...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::commands::list_postgresql_connections,
            api::commands::create_postgresql_connection,
            api::commands::update_postgresql_connection,
            api::commands::delete_postgresql_connection,
            api::commands::get_postgresql_secret,
            api::commands::connect_postgresql,
            api::commands::test_postgresql_connection,
            api::commands::disconnect_postgresql,
            api::commands::postgresql_list_databases,
            api::commands::postgresql_list_tables,
            api::commands::postgresql_list_columns,
            api::commands::postgresql_execute_query,
            api::commands::postgresql_explain_query,
            api::commands::list_etcd_connections,
            api::commands::create_etcd_connection,
            api::commands::update_etcd_connection,
            api::commands::delete_etcd_connection,
            api::commands::has_etcd_secret,
            api::commands::get_etcd_secret,
            api::commands::connect_etcd,
            api::commands::disconnect_etcd,
            api::commands::etcd_list_keys,
            api::commands::etcd_get_value,
            api::commands::etcd_set_value,
            api::commands::etcd_delete_key,
